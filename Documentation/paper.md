...
# Statement of need
Although there is a growing market for distributed wind technology, the industry lacks consistent and transparent methods for evaluating the costs and benefits of distributed wind [@barrows_valuing_2021]. Beginning in 2021, the Pacific Northwest National Laboratory developed a framework for valuing distributed wind projects [mongird_value_2021]. While this methodology has been used in two case study applications [@barrows_valuation_2021; @reilly_fiscal_2022] it does not exist as a broadly accessible calculation service. 
